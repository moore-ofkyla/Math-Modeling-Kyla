...
{	
	...
	//looking for break points... points where its chaotic or maybe sudden shift in ratio 
	...
	//value in front of depletionforce: -0.1, ratio:40-50 at 1000-1500 runs
	//value in front of depletionforce: -0.05, ratio:40-50 at 1000-1500 runs
	//value in front of depletionforce: -0.04, ratio:35 ish at 3000-3500 runs
	//value in front of depletionforce: -0.001, ratio: 50-60 at 1000-1500 runs
	//value in front of depletionforce: -0.003, ratio: 100-120 ish at 1000-1200 runs. Pretty significant jump. Potential break point?
	// ratio on 679 run:167.75 then the ratio on run 680 run:134.39. Weird jump
	//value in front of depletionforce: -0.005, ratio: 125... 115 at 1000-1500 runs. Way more poly 

	//value in front of depletionforce: -0.45, ratio: 23-27 ish at 1000-1500 runs. targert 24?
	//value in front of depletionforce: -4, ratio:about 1 at 1000-1500 runs.stronger pressure

	//value in front of depletionforce: -0.025, ratio: at 1000-1500 runs


//smaller depletion =less "pressure"
//greater depletion="more pressure",should see more oct



	CentralForce = -0.003*DepletionForce;
	Damp = 0.1;
