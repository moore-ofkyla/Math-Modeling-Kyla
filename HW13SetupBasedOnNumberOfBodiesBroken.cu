//nvcc HW13SetupBasedOnNumberOfBodiesBroken.cu -o bounce -lglut -lm -lGLU -lGL																													
...
void setInitailConditions()
{
	...
	densityOfCeres = (2.158e12); // kg/km^3
	volumeOfCeres =  434892765.4;// km^3. Equal to 434892765.4
	
	MassUnitConverter = 9.383e20/NUMBER_OF_BODIES; // kg
	LengthUnitConverter = 940/(sqrt(NUMBER_OF_BODIES)); // km
